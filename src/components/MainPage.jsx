                ...
                <div className='mb-10 text-center fade-in'>
                  <div>
                   <Link to="/">
                    ...
                    <button
                      className='
    text-base font-semibold rounded-full px-4 py-2
    bg-blue-600/40 text-white
    hover:bg-white
    hover:text-blue-600
    transition-colors duration-200
    relative left-[120px] bottom-[120px] 
    md:relative md:left-[400px] md:bottom-[20px]
  '
                    >
                      Login
                    </button>
                  ...
                  <p className='mx-auto max-w-md text-gray-300 text-sm md:text-lg'>
                    Your AI assistant is here to help you think, create, plan, and explore ideas
                    instantly.
                  </p>
                </div>
              )}
