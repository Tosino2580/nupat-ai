      ...
      <div className='relative z-10 w-full max-w-md'>
        ...
        >
          <div className='text-center mb-8'>
            ...
            <p className='text-gray-400 text-[14px] mt-2'>Enter your account to continue.</p>
          </div>

          {error && (
            <div className='bg-red-500 text-white p-3 rounded-xl mb-4 text-center'>{error}</div>
          )}
          ...
          <div className='space-y-6'>
            ...
            <div className='relative'>
              ...
              <input
                ...
                className='w-full p-3 pr-12 bg-gray-900 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:ring-blue-500 focus:outline-none'
                placeholder='••••••••'
                value={password}
